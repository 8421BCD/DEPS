...
def collate_fn_train(insts):
	...
	querys, docs1, docs2, label, next_q, features1, features2, delta, long_qdids, longpos, short_qdids, shortpos, docslist, docspos, doc1_order, doc2_order, session_docs_pos = zip(*insts)
	...
	session_docs_pos = torch.LongTensor(session_docs_pos)

	return querys, docs1, docs2, label, next_q, features1, features2, delta, long_qdids, longpos, short_qdids, shortpos, docslist, docspos, doc1_order, doc2_order, session_docs_pos

class Dataset_train(torch.utils.data.Dataset):
	def __init__(
		self, querys, docs1, docs2, label, next_q, features1, features2, delta, long_qdids, longpos, short_qdids, shortpos, docslist, docspos, doc1_order, doc2_order, session_docs_pos):
		self.querys = querys
		self.docs1 = docs1
		self.docs2 = docs2
		self.label = label
		...
		self.session_docs_pos = session_docs_pos
	...
	def __getitem__(self, idx):
		...
		session_docs_pos = self.session_docs_pos[idx]

		return querys, docs1, docs2, label, next_q, features1, features2, delta, long_qdids, longpos, short_qdids, shortpos, docslist, docspos, doc1_order, doc2_order, session_docs_pos

def collate_fn_score(insts):
	''' Pad the instance to the max seq length in batch '''
	querys, docs, features, long_qdids, longpos, short_qdids, shortpos, lines, docslist, docspos, doc_order, session_docs_pos = zip(*insts)
	...
	return querys, docs, features, long_qdids, longpos, short_qdids, shortpos, lines, docslist, docspos, doc_order, session_docs_pos

class Dataset_score(torch.utils.data.Dataset):
	def __init__(
		self, querys, docs, features, long_qdids, longpos, short_qdids, shortpos, lines, docslist, docspos, doc_order, session_docs_pos):
		self.querys = querys
		self.docs = docs
