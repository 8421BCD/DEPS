'''
    This is an experiment which uses coarse-grained documents interaction(ql)
'''
import random
import torch
import pickle
...
from model.Model_doc_inter2 import Contextual
import Constants
import torch
...
def prepare_train_data(sat_list, feature_list, doc_list, qids, long_qdids, short_qdids):
	...
	init_docpos[-1] = args.max_doc_list_train + 1
